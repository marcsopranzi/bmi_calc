...
def test_bmi_category_overweight_count():
    ...
    input = pd.DataFrame({'Gender':['Male', 'Male', 'Male', 'Female', 'Female', 'Female'],
                          'HeightCm':[171, 161, 180, 166, 150, 167],
                          'WeightKg':[96, 85, 77, 62, 70, 82],
                          'bmi_range_kg_m2':['Moderately obese','Moderately obese','Normal weight','Normal weight','Moderately obese','Overweight'],
                          'health_risk':['Medium risk', 'Medium risk', 'Low risk', 'Low risk', 'Medium risk', 'Enhanced risk']
                        })
